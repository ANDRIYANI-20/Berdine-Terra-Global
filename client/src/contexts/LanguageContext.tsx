...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "home.documents.coo": "Certificate of Origin (COO)",
    "home.documents.phyto": "Phytosanitary Certificate (when required)",
    ...
    "documentation.payment.tt5050": "T/T Deposit required, balance before shipment: Details provided during negotiation.",
  ...
  id: {
    ...
    "home.documents.commercial": "Commercial Invoice & Packing List",
    "home.documents.coo": "Certificate of Origin (COO)",
    "home.documents.phyto": "Phytosanitary Certificate (bila diperlukan)",
    ...
    "documentation.payment.tt5050": "T/T Uang muka diperlukan, pelunasan sebelum pengiriman: Detail diberikan saat negosiasi.",
