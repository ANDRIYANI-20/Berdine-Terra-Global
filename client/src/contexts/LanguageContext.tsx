...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "product.vanilla.gradeAPlus.moisture": "22-26%",
    "product.vanilla.gradeAPlus.length": "18-22 cm",
    ...
    "product.vanilla.gradeA.moisture": "26-30%",
    ...
    "product.vanilla.gradeB.moisture": "30-36%",
    "product.vanilla.gradeB.length": "12-16 cm",
    ...
    "product.vanilla.gradeC.moisture": "36-42%",
    "product.vanilla.gradeC.length": "10-13 cm",
    ...
    "product.coffee.altitude": "400-800m",
  ...
  id: {
    ...
    "documentation.guide1.topic1": "Klasifikasi Grade A",
